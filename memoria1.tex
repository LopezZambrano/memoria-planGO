...
Angular surge como evoluci\'on del framework AngularJS, el cual lanzado por Google en el 2009. Empez\'o a ser tendencia y a formar parte del inter\'es de los desarrollos en el 2012. Su crecimiento a partir de entonces fu\'e exponencial. Empezaron a salir librerias, que ayudaban a cubrir ciertas funcionalidades. Angular es un nuevo framework a pesar de venir de AngularJS.
...
\item Reactive Programming: 
	...
	Con este nuevo paradigma se intenta simplificar la arquitectura de las aplicaciones y centrarlo mas en el uso real de la aplicaciopn: responder a eventos, tareas asincronas y flujos con esas tareas asincronas, etc.
	Las ventajas de esto es el c\'odigo asincrono, que se hace mas sencillo por ejemplo hacer una peticion REST y procesarla y posteriormente unirlo a una actualizacion de la vista.
	Nos permite realizar un c\'odigo limpio, concurrente, escalable y f\'acil de gestion de procesos as\'incronos. 

	En Angular esto es utilizado en la libreria RXjs para binding y peticiones HTTP.
...
\begin{itemize}
  \item Buscar informaci\'on sobre tecnolog\'ias muy utilizadas en la actualidad y as\'i elegir con que tecnolog\'ias llevar a cabo el desarrollo de la aplicaci\'on.
  \item Realizar un tutorial en Angular y otro de Express para aprender a utilizar estos frameworks.
  \item Realizar dise\'no de las pantallas de la aplicaci\'on, de tal manera que sean lo m\'as intuitivas y f\'aciles para el usuario.
 \item Desarrollar las pantallas con su correspondiente funcionalidad.
 \item Desarrollar un resvidor REST mediante el framework Expess y conectar con la base de datos MongoDB.
 \item Dise\'nar la arquitectura del backend, es decir, definir los modelos y colecciones.
 \item Conectar la parte frontend con la parte backend, mediante peticiones HTTP.
 \item Testear la aplicaci\'on.
...
entre textos que pueden ser de cualquier tipo. Como se ve en la figura, esta eleccion se hace
...
si esto no se cumple, como se ve en la figura, se mostrara el error.
