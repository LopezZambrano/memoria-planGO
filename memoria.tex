...
horas y horas de estudio, nervios, malos momentos, pero sobre todo mucha felicidad de vernos conseguir nuestras metas.
...
como en los malos momentos y su gran apoyo.
...
Este trabajo de fin de grado describe el dise\~no y desarrollo de una aplicaci\'on para dispositivos m\'oviles con el sistema operativo Android. Su funcionalidad principal es la creaci\'on de encuestas que pueden ser dise\~nadas por un usuario desde el m\'ovil, y distribuidas a otros usuarios para que participen en las mismas. Uno de los principales usos de la aplicaci\'on es la toma de decisiones sobre cu\'ando llevar a cabo reuniones. El usuario que crea la encuesta podr\'a crear opciones de fechas y horas diversas, y durante la realizaci\'on de la encuesta podr\'a consultar en cualquier momento cu\'al es la opci\'on que tiene mayor n\'umero de votos, y a qui\'en pertenecen los mismos. 
...
Por \'ultimo, seg\'un las conclusiones obtenidas en la prueba del apartado \ref{sec:conclusion_prueba}, al ser una aplicaci\'on cuya funcionalidad nos la dan otras m\'as famosas, habr\'ia que pensar algo que la haga \'unica y capte la atenci\'on de los usuarios.
