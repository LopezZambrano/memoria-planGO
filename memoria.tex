...
Cada componente esta formado por tres ficheros: el typescript donde está la l\'ogica, el html donde está a vista y el css que modifica la vista.

En este proyecto, hay seis pantallas que están formadas únicamente por un componente y el componente header, y cuatro pantallas contienen más. 


\begin{figure}[H]
  \centering
  \includegraphics[width=15cm, keepaspectratio]{img/arq_comp.png}
