...
Para realizar todas las b\'usquedas en la base de datos, se han utilizado m\'etodos que da MongoDB para aplicarselos a coleciones. Los m\'etodos usados para filtrar han sido findById para filtrar por id, findOne para buscar un dato concreto. Para introducir o eliminar datos se han usado otros m\'etodos: 'save' y para borrar 'detele'.
...
\subsection{Relaciones base de datos} 
\label{sec:controladores}
