...
\begin{figure}[H]
 \centering
  \subfloat[Friend]{
   \label{f:friend}
    \includegraphics[width=0.3\textwidth]{img/mod_friend.png}}
  \subfloat[Poll]{
   \label{f:poll}
    \includegraphics[width=0.3\textwidth]{img/mod_poll.png}} 
\\
\subfloat[User]{
   \label{f:user}
    \includegraphics[width=0.3\textwidth]{img/mod_user.png}}
\subfloat[Vote]{
   \label{f:vote}
    \includegraphics[width=0.3\textwidth]{img/mod_vote.png}}
 \caption{Modelos}
 \label{f:modelos_front}
\end{figure}
