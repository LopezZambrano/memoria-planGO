...
Este trabajo de fin de grado describe el dise\~no y desarrollo de una aplicaci\'on para dispositivos m\'oviles con el sistema operativo Android. Su funcionalidad principal es la creaci\'on de encuestas que pueden ser dise\~nadas por un usuario desde el m\'ovil, y distribuidas a otros usuarios para que participen en las mismas. Uno de los principales usos de la aplicaci\'on es la toma de decisiones sobre cuándo llevar a cabo reuniones. El usuario que crea la encuesta podrá crear opciones de fechas y horas diversas, y durante la realizaci\'on de la encuesta podrá consultar en cualquier momento cuál es la opci\'on que tiene mayor n\'umero de votos, y a qui\'en pertenecen los mismos. 
