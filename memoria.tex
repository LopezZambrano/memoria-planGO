...
El c\'odigo fuente de la aplicaci\'on se encuentra en repositorios de GitHub. Por una parte esta el proyecto de \emph{frontend} cuyo c\'odigo se encuentra en \url{https://github.com/LopezZambrano/prueba/tree/master/planGO} y el c\'odigo de \emph{backend} se encuentra en \url{https://github.com/LopezZambrano/node-api-rest}. Utilizar esta herramienta permite tener un buen control de versiones.
...
Como cualquier aplicaci\'on, existen varias versiones de la misma e incluso cuando ya est\'a en producci\'on. Esto se debe a que hay mejores continuas y correci\'on de errores, as\'i como propuestas que realizan los propios usuaruis. En las stores de app es posible valorar cada aplicaci\'on y a\~nadir quejas y sugerencias. Esta es la mejor manera de que la aplicaci\'on evolucione. Hasta que una aplicaci\'on no esta en uso, no salen las verdaderas necesidades.
