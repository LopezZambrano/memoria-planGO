...
En este proyecto, hay pantallas que est\'an formadas \'unicamente por un componente y otras que contienen m\'as. En
la figura \ref{figura:arq_comp}, de forma esquem\'atica, podemos ver que componentes forman cada una de las pantallas. La pantalla de login es la \'unica que realmente contiene un \'unico componente, en cambio Registro, Home y Perfil aparte de su propio componente, est\'an formados por el componente com\'un Header.
...
Durante el grado de Ingenier\'ia en Sistemas de Telecomunicaci\'on, solo he tenido una asignatura relacionada con este proyecto. Esta asignatura se llama . Este proyecto ha sido inspirado en esta asignatura, ya que me pareci\'on tan interesante que he querido profundizar en ello.
...
https://desarrolloweb.com/articulos/estructura-proyecto-ionic2.html

http://slashmobility.com/blog/2016/08/ionic-2-el-framework-del-futuro/

https://code.tutsplus.com/es/articles/introduction-to-ionic-2--cms-28193

http://enekodelatorre.com/expressjs-instalacion-primeros-pasos/

https://www.adictosaltrabajo.com/tutoriales/primeros-pasos-con-express/#41

http://expressjs.com/es/

https://es.wikipedia.org/wiki/NoSQL

http://cidecame.uaeh.edu.mx/lcc/mapa/PROYECTO/libro14/412_inconsistencia_de_datos.html

http://www.biblogtecarios.es/inmaherrero/herramientas-para- programar-
reuniones-mas- alla-de- doodle/

http://www.mclibre.org/consultar/htmlcss/otros/historia_resumen.html
