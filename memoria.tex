...
En la carpeta de variables hay una serie de ficheros que contienen las  variables comunes utilizadas en toda la aplicaci\'on para el dise\'no. De esta manera los colores son iguales,
 tama\'nos e iconos son comunes en toda la app. Este es un ejemplo de buenas prácticas, si fuera necesario cambiar la apariencia de toda la aplicaci\'on, bastaria con modificar alguna de estas variables.

Con respecto a los ficheros, uno de gran importancia para la aplicaci\'on es el app.module.ts, ya que en él están declarados todos los componentes y servicios que han sido creados. Para reglas de CSS que sean comunes para toda la aplicaci\'on, se utiliza el fichero app.css. 
